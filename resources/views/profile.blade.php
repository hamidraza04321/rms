              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control" placeholder="Enter Your Email" value="{{ $data['user']->email }}" @disabled(!$data['user']->can('profile-update-credentials'))>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>User Name <span class="error">*</span></label>
                    <input type="text" name="username" id="username" class="form-control" placeholder="Enter Username" value="{{ $data['user']->username }}" @disabled(!$data['user']->can('profile-update-credentials'))>
                  </div>
                  <div class="form-group">
