                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="is_default" id="is-default" class="form-control select2">
                          ...
                          <option @selected($data['grade']->is_default) value="1">Yes</option>
                          <option @selected(!$data['grade']->is_default) value="0">No</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="class_id" id="class-id" class="form-control select2" @disabled($data['grade']->is_default)>
                          <option value="">Select</option>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="remarks" id="remarks" class="form-control" value="{{ $data['grade']->remarks }}" placeholder="Enter Remarks">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
