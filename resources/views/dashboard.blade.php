    ...
    <section class="content">
      <div class="container-fluid">
        @can('dashboard-widgets')
          ...
          <div class="row">
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-info">
                ...
                <a href="{{ (auth()->user()->can('general-settings-view')) ? route('general.settings') : '#' }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                ...
                <a href="{{ (auth()->user()->can('view-user')) ? route('user.index') : '#' }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-warning">
                ...
                <a href="{{ (auth()->user()->can('view-student')) ? route('student.index') : '#' }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
          ...
          <!-- /.row -->
        @endcan
        @canany([ 'dashboard-attendance-graph', 'dashboard-total-students-graph' ])
          <div class="row">
            @can('dashboard-attendance-graph')
              <div class="col-lg-6">
                <div class="card">
            ...
            @endcan
            @can('dashboard-total-students-graph')
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex justify-content-between">
