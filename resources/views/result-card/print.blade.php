                    ...
                    <form action="{{ route('get.result.cards') }}" id="get-result-cards-form">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Class</label>
                            <select name="class_id" id="class-id" class="select2 form-control" disabled>
                              <option value="">Select</option>
                            </select>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Section</label>
                            <select name="section_id" id="section-id" class="select2 form-control" disabled>
                              <option value="">Select</option>
                            </select>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <button id="btn-search-result-cards" class="btn btn-primary mt-30"><i class="fa fa-search"></i> Search</button>
                          </div>
                        </div>
                      </div>
                    </form>
