  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="accordion" id="student-filters">
              <div class="card card-primary card-outline">
                ...
                <div id="student-filters-table" class="collapse show" aria-labelledby="student-filter-heading" data-parent="#student-filters">
                  <div class="card-body">
                    <form action="{{ route('get.students.attendance.report') }}" id="get-students-attendane-report-form">
                      <div class="row">
                        <div class="col-md-3">
                      ...
                      <div class="row">
                        <div class="col-md-12 text-right">
                          <button id="btn-search-report" class="btn btn-primary"><i class="fa fa-search"></i> Search</button>
                        </div>
                      </div>
                    </form>
                  </div>
        ...
        <!-- /.row -->
        <div id="students-attendance-report"></div>
      </div>
      <!-- /.container-fluid -->
    </section>
  </div>
@endsection
@section('scripts')
<script src="{{ url('/assets/js/attendance-report.js') }}"></script>
@endsection