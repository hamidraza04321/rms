                                    ...
                                    <tr>
                                      <td>
                                        <div class="form-check">
                                          <input class="form-check-input class-permission" type="checkbox" name="permissions[{{ $class->id }}]" value="{{ $class->id }}">
                                      ...
                                      <td>
                                        @foreach($class->sections as $section)
                                          <div class="form-check">
                                            <input class="form-check-input permission" type="checkbox" name="permissions[{{ $class->id }}][section_id][]" value="{{ $section->section->id }}">
                                      ...
                                      <td>
                                        @foreach($class->subjects as $subject)
                                          <div class="form-check">
                                            <input class="form-check-input permission" type="checkbox" name="permissions[{{ $class->id }}][subject_id][]" value="{{ $subject->subject->id }}">
                                      ...
                                      <td>
                                        @foreach($class->groups as $group)
                                          <div class="form-check">
                                            <input class="form-check-input permission" type="checkbox" name="permissions[{{ $class->id }}][group_id][]" value="{{ $group->group->id }}">
